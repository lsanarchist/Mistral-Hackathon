...
func TestPerformanceAlerts(t *testing.T) {
	server := NewWebSocketServer(8080, "./testdata", "./testdata", false, false, false, 0*time.Second, false, nil, nil, ConnectionQualityConfig{}, false, false, false, false, false)
	defer server.Stop()
...
func TestPerformanceAnnotations(t *testing.T) {
	server := NewWebSocketServer(8080, "./testdata", "./testdata", false, false, false, 0, false, nil, nil, ConnectionQualityConfig{}, false, false, false, false, false)
	defer server.Stop()
...
func TestAlertTriggering(t *testing.T) {
	...
	server := NewWebSocketServer(8080, "./testdata", "./testdata", false, false, false, 0*time.Second, false, alerts, nil, ConnectionQualityConfig{}, false, false, false, false, false)
	defer server.Stop()
...
func TestWebSocketConnectionQualityMonitoring(t *testing.T) {
	server := NewWebSocketServer(8080, "./testdata", "./testdata", false, false, false, 0*time.Second, true, nil, nil, ConnectionQualityConfig{}, false, false, false, false, false)
	defer server.Stop()
